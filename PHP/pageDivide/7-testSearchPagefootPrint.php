...
<form action="#" method="get">
	...
	<hr color="blue"/>
	<?php echo showPage($page,$totalPages,$searchStr)?>
	<hr color="blue"/>
	<?php echo showPage($page,$totalPages,$searchStr,true)?>
	<hr color="blue"/>
	<?php echo showPage($page,$totalPages,$searchStr,false,true)?>
</body>
<script>
	var showPage=document.querySelector("#goPage");
